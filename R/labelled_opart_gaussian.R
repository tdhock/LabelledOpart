...
labelled_opart_gaussian <- function(data, labels, penalty) {
  ...
  result <- .C("labelled_opart_gaussian_interface",
               ...
               indicator = integer(length(data)),
               closest = integer(length(data)),
               sums = double(length(data)),
               dp = double(length(data)),
               vt = double(length(data)),
               end.vec = integer(length(data)),
               positions = integer(length(data)),
               vt_end = integer(length(data)),
  ...
  result <- result[c("positions", "vt_end", "cost.vec", "end.vec")]
